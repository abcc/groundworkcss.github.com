...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="two centered thirds tripple padded align-center">
        <h1 class="heading responsive"><i class="icon-thumbs-down"></i> Not found</h1>
        <h3 class="responsive">Sorry, but the page you were trying to view does not exist.</h3>
        <div class="row">
          <div class="one centered small-tablet half padded align-left">
            <h3>It looks like this could be the result of:</h3>
            <ul class="list">
                <li>A mistyped address</li>
                <li>An out-of-date link</li>
                <li>An engineer needing a coffee</li>
            </ul>
          </div>
        </div>
      </div>
